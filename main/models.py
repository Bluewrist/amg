...
class Product(models.Model):
    ...
    part_number_1 = models.CharField(max_length=12,null=True,blank=True)
    part_number_2 = models.CharField(max_length=12,null=True,blank=True)
...
class Product_images(models.Model):
    ...
    def __str__(self) -> str:
        return self.product_id.part_name 
